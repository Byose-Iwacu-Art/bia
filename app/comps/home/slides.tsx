...
const slides = [
  { image: '/imgs/rm/c2-removebg-preview.png', text: 'Discover the Elegance of Rwandan Fashion', description: 'Discover the architecture made by Rwandan on this cloth as the result of culture dress', reference: '/products/category/Women Dress', category: 'Womens dress'},
  { image: '/imgs/rm/c8-removebg-preview.png', text: 'Handcrafted Baskets with a Touch of Tradition', description: 'Discover the architecture made by Rwandan on this clothing', reference: '/products/category/Men Shirts', category: 'Clothing'},
  ...
  { image: '/imgs/rm/cat20-removebg-preview.png', text: 'Discover the Elegance of Rwandan Fashions', description: 'Discover the architecture made by Rwandan on this cloth as the result of culture Matts', reference: '/products/category/Table Matt', category: 'Womens dress'},
